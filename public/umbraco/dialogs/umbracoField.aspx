 ...
 <script type="text/javascript">
      ...
      if (document.forms[0].urlEncode[1].checked)
			...
			<%if (umbraco.UmbracoSettings.UseAspNetMasterPages){ %>
			  tagString += " runat=\"server\"></" + document.forms[0].<%= tagName.ClientID %>.value + ">";
			<%} else { %>
			  tagString += " />";
			<%} %>
...
<asp:Content ContentPlaceHolderID="body" runat="server">
    ...
    <cc1:Pane ID="pane_form" runat="server">
      <cc1:PropertyPanel ID="pp_insertField" runat="server">
        <asp:ListBox ID="fieldPicker" Width="170px" Rows="1" runat="server"></asp:ListBox> <input type="text" size="25" name="field" class="guiInputTextTiny">
      </cc1:PropertyPanel>
      ...
      <cc1:PropertyPanel ID="pp_insertAltField" runat="server">
          ...
          <span class="guiDialogTiny"><%=umbraco.ui.Text("templateEditor", "usedIfEmpty")%></span>
      </cc1:PropertyPanel>
      ...
      <cc1:PropertyPanel ID="pp_insertAltText" runat="server">
          ...
          <span class="guiDialogTiny"><%=umbraco.ui.Text("templateEditor", "usedIfAllEmpty")%></span>
      </cc1:PropertyPanel>
      
      <cc1:PropertyPanel ID="pp_recursive" runat="server">
          <input type="checkbox" name="recursive" value="true"> <%=umbraco.ui.Text("yes")%>  <br />
      </cc1:PropertyPanel>
      ...
      <input type="radio" name="formatAsDate" value="formatAsDate"> <%=umbraco.ui.Text("templateEditor", "dateOnly")%>
          &nbsp; &nbsp; 
          <input type="radio" name="formatAsDate" value="formatAsDateWithTime"> <%=umbraco.ui.Text("templateEditor", "withTime")%> : <input type="text" size="6" name="formatAsDateWithTimeSeparator" class="guiInputTextTiny">
          <br /><span class="guiDialogTiny">Format the value as a date, or a date with time, accoring to the active culture.</span>
      </cc1:PropertyPanel>
      ...
      <cc1:PropertyPanel ID="pp_encode" runat="server">
          <input type="radio" name="urlEncode" value=""> <%=umbraco.ui.Text("none")%>
            <input type="radio" name="urlEncode" value="url"> <%=umbraco.ui.Text("templateEditor","urlEncode")%>
              <input type="radio" name="urlEncode" value="html"> <%=umbraco.ui.Text("templateEditor", "htmlEncode")%>
          <br />
          <span class="guiDialogTiny">
